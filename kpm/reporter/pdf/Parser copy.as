package com.kpm.reporter.pdf{
	...
	public class Parser extends DefaultPdf{		
		...
		Constructor
		**/
		public function Parser(xmlInput:XML,embedFontsData:Dictionary){
			super(embedFontsData);			
			this.error = false;
			this.xmlInput = xmlInput;
			//Metodo heredado de DefaultPdf
			this.registerFonts(); 
		...
		**/
		protected function addImage(node:XML):void{
            ...
            trace("here is the path to images " + pathImg);
		...
		**/
		protected function writeParagraph(node:XML):void{						
			this.document.add(this.parseParagraph(node));			
		}
