package com.kpm.reporter.pdf{
	...
	public class Parser extends DefaultPdf{		
		...
		Constructor
		**/
		public function Parser(xmlInput:XML, embedFontsData:Dictionary, externalReport:DefaultPdf){			
			super(embedFontsData);
			if(externalReport !== undefined)
				if(externalReport === null) //Este pdf es el primero a mergear. Se crea el objeto pdf merge.
					this.externalReport = new DefaultPdf(embedFontsData);				
				else //No es necesario crear el objeto merge, sólo se agregará contenido.
