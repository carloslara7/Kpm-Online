...
package com.coltware.airxmail
{
	...
	public class MimeBinaryPart extends MimeBodyPart
	{
		...
		public function setAttachementFile(file:File,filename:String = null):void{
            ...
            trace("attach " +  file + " " + fs.bytesAvailable);
			...
			if(filename != null){
                ...
                trace("Attachment setattacmentfile" + charset);
        ...
        public function setAttachementStream(fs:ByteArray,filename:String = null):void{

            $bodySource = fs;

            trace("set attachment stream " + $bodySource.bytesAvailable);
