	...
	public class MimeMessage extends MimeMultiPart{
		...
		*/
		...
		public function setTextBody(body:String):void{
			...
			if($__debug__) trace("content-type " + this.contentType.getValue());
			...
			if($__debug__) trace("setTextBody " + _charset + "/" + body.length + " " + $bodySource.length);
		}
