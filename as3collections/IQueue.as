...
{
	import com.as3collections.ICollection;

	/**
	 * Defines the queue data structure.  A queue is a specific kind of collection where
	 * are added to it at one end, and removed from it from the other end.  You add an item to it using
	 * the enqueue, and remove an item from it using dequeue.
	 * 
